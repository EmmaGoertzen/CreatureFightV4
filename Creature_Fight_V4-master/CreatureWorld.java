...
/**
 * Everything that happens in the world/"play feild"
 * 
 * @author (Emma) 
 * @version (1/15/2019)
 */
public class CreatureWorld extends World
{
    ...
    /**
     * act will run actions that the Creature object should
     * work while the scenario is running
     * 
     * @param There are no parameters
